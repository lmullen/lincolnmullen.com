...
{{< figure src="2013-03-16.10PRINT-1.png" >}}
...
> Here's the Perl equivalent of that code!my @a=qw( /  ); while (1) {print $a[rand @a];sleep 0.01;} print ""; #dhtng
>
> --- Shane Landrum (@cliotropic) [March 16, 2013](https://twitter.com/cliotropic/status/312987216248991745)

> #dhtng Slightly cleaner: in OS X Terminal: perl -e 'my @a=qw( /  ); while (1) {print $a[rand @a];}';
>
> --- Shane Landrum (@cliotropic) [March 16, 2013](https://twitter.com/cliotropic/status/312987627991224322)

> Here's 10PRINT in Ruby as a one-liner. Run it in Terminal. ruby -e 'printf ["/",""][Random.new.rand(0..1)] while true' #dhtng
>
> --- Lincoln Mullen (@lincolnmullen) [March 16, 2013](https://twitter.com/lincolnmullen/status/312992092882354176)
...
{{< figure src="2013-03-16.10PRINT-2.png" >}}
...
{{< figure src="2013-03-16.10PRINT-3.png" >}}
