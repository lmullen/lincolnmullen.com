...
- Jay A. Kreibich, _Using SQLite_ (O'Reilly, 2010), chs. 1, 2, 4, 5, 6.
...
- Mark E. J. Newman, [_Networks: An Introduction_](https://math.bme.hu/~gabor/oktatas/SztoM/Newman_Networks.pdf) (Oxford University Press, 2010), ch. 1, 3, 4. Skim chs. 6, 7.
...
You are welcome to use generative AI for any part of this class; in fact, I hope to model for you how to do so. There are two requirements, however. The first is that you must be willing to put your name on anything you submit for the class. The second is that you must include a brief note explaining how you used generative AI alongside (but not as a part of) your assignment.
