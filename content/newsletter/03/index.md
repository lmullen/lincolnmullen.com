...
A few years ago, I made a few interactive maps with D3 (such as [this](https://projects.lincolnmullen.com/slavery/) and [this](https://projects.lincolnmullen.com/us-boundaries/)). But mostly I've done my visualization work in R. In the interim a lot has changed with D3 and, indeed, with JavaScript and the web itself. I've been acquainting myself with the recent developments.
